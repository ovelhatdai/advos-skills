...
Versão 0.1.3 — 2026-09-23. Pacote genérico para configurar, testar e depurar o AdvOS no **próprio escritório**. Não inclui acesso ao AdvOS, credenciais, dados de clientes ou configuração de outra organização.
