...
Versão: 0.1.0 (2026-09-23). Esta skill é um roteiro de investigação, não uma descrição garantida da versão atual do produto. Confira a interface e as permissões reais a cada uso.
...
4. Use o diagnóstico que o AdvOS expuser para correlacionar entrada, tratamento de mídia, disparo do agente, tentativa de envio e recibo. Anote apenas IDs técnicos necessários, sem conteúdo sensível.
5. Reproduza em contato de teste autorizado. Não use uma conversa real de cliente como experimento descartável.
6. Relate fato observado, causa comprovada ou hipótese em campos separados. Se uma hipótese não foi verificada, deixe-a como pendência.
